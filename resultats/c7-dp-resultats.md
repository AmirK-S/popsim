...
D4 (permutation intra-segment, notre meilleure defense) : top1 = 0,126 % [0,012 ; 0,284], perte = 1,47 pt (`c7-defense-courbe.csv`). Fidelite DP quasi nulle partout (< 0,2 pt) : aucun conditionnement par personne, meme pas par segment.
